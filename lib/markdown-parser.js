...
// `path_1` may be the namespace or an object with `default` depending on how
// TypeScript was transpiled. Normalize to `path` so `basename`/`extname` are available.
var path = (path_1 && path_1.default) ? path_1.default : path_1;
